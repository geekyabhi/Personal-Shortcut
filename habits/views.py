...
def _validate(period, year, month, week, day):
...
def _common_fetch(request):
    ...
    err = _validate(period, year, month, week, day)
    if err:
...
class HabitsChartView(View):
    def get(self, request):
        ...
        habit_rates = {
            ...
            "values": [round(c / total_days * 100, 1) if total_days else 0 for _, c in sorted_habits],
        }
